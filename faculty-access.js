...
window.UCVM=(()=>{
 ...
 function facultyState(form,initial=false){const out={};for(const [f,l] of [['ucid','UCID'],['preferredFullName','Preferred name'],['hrFullName','HR full name'],['firstName','First name'],['lastName','Last name'],['email','Email'],['reportsTo','Reports to'],['currentTitle','Current title'],['rank','Rank'],['teachingArea','Teaching area'],['teachingAreaEmphasis','Teaching emphasis'],['fte','FTE'],['campus','Campus'],['office','Office']])out[f]={label:l,value:fieldValue(form,f,initial)};return out}
